...
figure();
plot(recordT, recordY(1, :), 'DisplayName', 'substrate')
hold on
plot(recordT, recordY(2, :), 'DisplayName', 'enzym')
plot(recordT, recordY(3, :), 'DisplayName', 'complex')
plot(recordT, recordY(4, :), 'DisplayName', 'product')
