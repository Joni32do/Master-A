...
figure();
plot(recordT, recordX(1, :), 'DisplayName', 'substrate')
hold on
plot(recordT, recordX(2, :), 'DisplayName', 'enzym')
plot(recordT, recordX(3, :), 'DisplayName', 'complex')
plot(recordT, recordX(4, :), 'DisplayName', 'product')
title("Stochastic Simulation Algorithm")
legend();
hold off
